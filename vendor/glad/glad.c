/*
    ...
    OpenGL loader generated by glad 0.1.36 on Mon Feb 17 03:26:53 2025.
    ...
    Commandline:
        --profile="compatibility" --api="gl=4.1" --generator="c" --spec="gl" --no-loader --local-files --extensions=""
    Online:
